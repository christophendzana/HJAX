 ...
 */
public class BasicHRibbonUI extends HRibbonUI {
    ...
    /**
     * Retourne une instance partagée (singleton pattern) utilisée par UIManager.
     *
     * Signature requise par le mécanisme de UIManager : public static ComponentUI createUI(JComponent)
     */
    ...
    protected void initializeColors() {
        ...
        if (ribbonBackground == null) {
            ribbonBackground = new Color(240, 240, 25); // Gris clair par défaut
        }
        ...
        if (groupDividerColor == null) {
            groupDividerColor = new Color(200, 123, 41); // Gris moyen
        }
    ...
    public void installUI(JComponent c) {
        if (!(c instanceof Ribbon)) {
            throw new IllegalArgumentException("BasicHRibbonUI can only be installed on Ribbon");
        }
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        // 3. La peinture des composants enfants est gérée par Swing (ils seront peints après)
    }
