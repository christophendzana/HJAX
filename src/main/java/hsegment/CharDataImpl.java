 ...
 * @author PSM
 */
public abstract class CharDataImpl extends NodeImpl implements CharData {

    public String data;
    
    public CharDataImpl(String data, short nodeType, DocumentImpl holderDocument) {
        super("#Text", nodeType, holderDocument);
