...
public interface Node {
    ...
    /**
     * Le nom de ce nœud, en fonction de son type ; voir le tableau ci-dessus.
     *
     * @return
     */
    ...
    /**
     * La valeur de ce nœud, selon son type ; voir le tableau ci-dessus.
     * Lorsqu'il est défini comme <code>null</code>, sa définition n'a aucun
     * effet, même si le nœud est en lecture seule.
     *
     * @return
     * @exception HJAXException DOMSTRING_SIZE_ERR : déclenchée lorsqu'elle
     * renvoie plus de caractères que ne peut contenir une variable
     * <code>DOMString</code> sur la plateforme d'implémentation.
     *
     */
    ...
    /**
     * Un code représentant le type de l'objet sous-jacent, tel que défini
     * ci-dessus.
     */
    ...
    /**
     * Un <code>NamedNodeMap</code> contenant les attributs de ce nœud (si il
     * s'agit d'un <code>Element</code>) ou <code>null</code> sinon.
     */
    public NamedNodeMapImpl getAttributes();

    /**
     * L'objet <code>Document</code> associé à ce nœud. Il s'agit également de
     * l'objet <code>Document</code> utilisé pour créer de nouveaux nœuds.
     * Lorsque ce nœud est un <code>Document</code> ou un
     * <code>DocumentType</code> qui n'est pas encore utilisé avec un
     * <code>Document</code>, il est nul.
     *
     ...
     * insère <code>newChild</code> à la fin de la liste des enfants.
    ...
    /**
     * Cet attribut renvoie le contenu textuel de ce nœud et de ses descendants.
     * Lorsqu'il est défini comme <code>null</code>, sa définition n'a aucun
     ...
     * définie pour cet attribut.
     * <br> Lors de la récupération, aucune sérialisation n'est effectuée ; la
    ...
    /**
     * Renvoie si ce nœud est identique au nœud donné.
     * <br>Cette méthode permet de déterminer si deux références
