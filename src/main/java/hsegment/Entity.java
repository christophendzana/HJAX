...
public interface Entity {
     ...
     * L'identifiant public associé à l'entité si spécidié, et null sinon.
     * il permet au parseur de reconnaitre la DTD
     */
     ...
     * L'identifiant public associé à l'entité si spécidié, et null sinon.
     * Cela peut être un URI absolu ou non.
     ...
     * retourne le nom de la notaion de l'entité pour les entités non analysées
     ...
     * is not known.
     * un attribut spécifiant l'encodage utilisé pour cette entité au moment de
