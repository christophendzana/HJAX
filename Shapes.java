...
public class Shapes {
    ...
    public enum ShapeType implements ShapeBuilder {
        ...
        RECTANGLE {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE));
            }
        },
        ROUNDED_RECTANGLE {
            public ShapeGeometry build(int x, int y, int w, int h) {
        ...
        RECTANGLE_ONE_CORNER_CUT {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.CUT, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE));
            }
        },
        RECTANGLE_OPPOSITE_CORNERS_CUT {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.CUT, CornerStyle.NONE, CornerStyle.CUT, CornerStyle.NONE));
            }
        },
        RECTANGLE_ADJACENT_CORNERS_CUT {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.CUT, CornerStyle.CUT, CornerStyle.NONE, CornerStyle.NONE));
            }
        },
        RECTANGLE_ONE_CORNER_ROUND {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.ROUND, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE));
            }
        },
        RECTANGLE_OPPOSITE_CORNERS_ROUND {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.ROUND, CornerStyle.NONE, CornerStyle.ROUND, CornerStyle.NONE));
            }
        },
        RECTANGLE_ADJACENT_CORNERS_ROUND {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h, CornerStyle.ROUND, CornerStyle.ROUND, CornerStyle.NONE, CornerStyle.NONE));
            }
        },
        TRIANGLE {
            public ShapeGeometry build(int x, int y, int w, int h) {
        ...
        PLATE {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(rectanglePath(x, y, w, h,
                        CornerStyle.CUT, CornerStyle.CUT, CornerStyle.CUT, CornerStyle.CUT));
            }
        },
        L_SHAPE {
            public ShapeGeometry build(int x, int y, int w, int h) {
        ...
        RIGHT_ARROW {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(horizontalArrow(x, y, w, h, true));
            }
        },
        LEFT_ARROW {
            public ShapeGeometry build(int x, int y, int w, int h) {
                return closedShape(horizontalArrow(x, y, w, h, false));
            }
        },
        UP_ARROW {
            public ShapeGeometry build(int x, int y, int w, int h) {
        ...
        RECTANGULAR_CALLOUT {
            public ShapeGeometry build(int x, int y, int w, int h) {
                Path2D body = rectanglePath(x, y, w, h, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE, CornerStyle.NONE);
                Path2D combined = new Path2D.Double();
        ...
        ROUNDED_RECTANGULAR_CALLOUT {
            public ShapeGeometry build(int x, int y, int w, int h) {
                Path2D body = rectanglePath(x, y, w, h, CornerStyle.ROUND, CornerStyle.ROUND, CornerStyle.ROUND, CornerStyle.ROUND);
                Path2D combined = new Path2D.Double();
                combined.append(body, false);
                combined.append(calloutTail(x, y, w, h), false);
                return closedShape(combined);
...
// Flèche pleine (Lot 4a) avec un triangle retranché à l'arrière
        private static Area notchedArrowPath(int x, int y, int w, int h) {
            Area area = new Area(horizontalArrow(x, y, w, h, true));
...
// Traînée de petits cercles décroissants (bulle de pensée)
    ...
    public static class FreeformShape {
        ...
        public ShapeGeometry buildGeometry() {
            ...
            return new ShapeGeometry(path, null); // ici jamais de remplissage pour ces formes
        }
    }
