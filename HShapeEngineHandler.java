 ...
 * @author FIDELE
 */
public final class HShapeEngineHandler implements ViewModelListener, ListViewSelectionListener {
    ...
    public HShapeEngineHandler(JComponent host) {
        this(host, null, null);
    }

    public HShapeEngineHandler(JComponent host, ViewModel model) {
        this(host, model, null);
    }

    public HShapeEngineHandler(JComponent host, ViewModel model, ViewModelSelection selectionModel) {
    ...
    private void onPress(MouseEvent e) {
        if (shapeEditor.isEditing()) {
        shapeEditor.stopEditing();
    }
        for (HShapeResizer resizer : getShapeResizers()) {
