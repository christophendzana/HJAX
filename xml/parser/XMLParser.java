...
import hsegment.JObject.Swing.Text.xml.ValidatorProcessor;
 ...
 */
public class XMLParser extends Parser implements DTDConstants{
    ...
    protected EntityHandler entHandler;
    protected ErrorHandler errHandler;
    protected TagHandler tagHandler;
    protected TextHandler texHandler;
    protected CommentHandler comHandler;
    protected HandlePrologue proHandler;
    protected ValidatorHandler doctHandler;
    protected InstructionTagHandler instHandler;
    private ValidatorProcessor validator;
    public XMLParser(){
    ...
    public class XMLRulesImpl {
        ...
        public  void validateNameSyntax(String str){
            ...
            if(str.equalsIgnoreCase("EMPTY") || str.equalsIgnoreCase("ANY") || str.equalsIgnoreCase("PCDATA")){
                error("XML.Error", str+" is XML reserved Name", "Change with another name");
            }
            switch(str.charAt(0)){
